...
@php
    ...
    $namaBulan = Carbon::parse($tahun . '-' . $bulan . '-01')
        ->translatedFormat('F');
...
<section class="content">
    ...
    <div class="container-fluid">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="bulan"
                                ...
                                @for($i = 1; $i <= 12; $i++)
                                    ...
                                    @php
                                        $valueBulan = sprintf('%02d', $i);
                                    @endphp

                                    <option value="{{ $valueBulan }}"
                                        {{ $bulan == $valueBulan ? 'selected' : '' }}>

                                        {{ Carbon::parse('2026-' . $valueBulan . '-01')->translatedFormat('F') }}
        ...
        <div class="alert alert-warning shadow-sm">
            ...
            Menampilkan data absensi bulan :
                        ...
                        @empty
                            ...
                            <tr>
                                ...
                                <td colspan="8"
                                    ...
                                    Tidak ada data laporan bulan ini.
